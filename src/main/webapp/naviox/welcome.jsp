...
In GestionONG-labels_en.properties:
GestionONG=My application
GestionONG[description]=My application does this and that

In GestionONG-messages_en.properties:

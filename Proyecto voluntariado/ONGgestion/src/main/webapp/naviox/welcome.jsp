...
In ONGgestion-labels_en.properties:
ONGgestion=My application
ONGgestion[description]=My application does this and that

In ONGgestion-messages_en.properties:

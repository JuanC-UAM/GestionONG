...
In GestiondeONG-labels_en.properties:
GestiondeONG=My application
GestiondeONG[description]=My application does this and that

In GestiondeONG-messages_en.properties:
